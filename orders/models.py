...
class Orden(models.Model):
    ...
    # Bifurcacion en EN_PREPARACION: retiro en tienda (LISTO_PARA_RETIRO) o despacho (ENVIADA)
    ...
    def _generar_codigo(self):
        # No secuencial (parte aleatoria) para evitar enumeracion en el buscador publico
        for _ in range(10):
