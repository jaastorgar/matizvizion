(function () {
  ...
  function fechaDe(s){ return String(s).slice(0,10); }
  ...
  function load() {
    ...
    api.get('/admin/stats/').then(function (r){
      var d = (r.ok && r.data) ? r.data : {};
      render(d.ordenes || [], d.citas || [], d.productos || [], d.devoluciones || [], desde, hasta);
    });
  }
  ...
  MV.me().then(function (u){
    ...
    document.getElementById('bi-hasta').value = iso(d);   // incluye HOY
